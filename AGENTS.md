...
- This is a public open-source repository. Do not commit private commercial strategy, competitor intelligence, pricing experiments, unreleased business roadmaps, customer/revenue plans, or other confidential planning material. Public branches, issues, PRs, commit messages, and docs should describe only the minimum public technical context required for the open-source product.
