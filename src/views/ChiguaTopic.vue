...
.event-evidence-popover > strong { padding: 2px 5px 5px; color: var(--n-text-color-2); font-size: 12px; }
...
.event-evidence-popover small { color: var(--n-text-color-3); font-size: 10px; }
.category-pill,
.source-pill,
.intelligence-pill,
