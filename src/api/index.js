...
const DEFAULT_TRENDS_READ_SOURCES = import.meta.env.PROD ? "github,36kr,baidu,zhihu,bilibili,weibo,ithome,douyin,kuaishou,qq-news,sina-news,thepaper,netease-news,tieba,smzdm,juejin,huxiu,sspai,geekpark,ifanr,52pojie,51cto,csdn,dgtle,hostloc,v2ex,nodeseek,hackernews,guokr,hellogithub,newsmth,ngabbs,zhihu-daily,producthunt,history,earthquake,weatheralarm,yystv,sina,gameres,ithome-xijiayi,nytimes,acfun" : "";
