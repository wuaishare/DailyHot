...
assert.match(chigua, /class="topic-trend-strip"[\s\S]{0,160}<div class="topic-trend-list">/);
assert.match(chigua, /\.topic-trend-strip \{[\s\S]{0,80}min-width: 0/);
...
assert.match(chigua, /\.radar-trend-item em \{[^}]*font-size: 12px/);
assert.match(chigua, /\.radar-trend-item strong \{[^}]*font-size: 12px/);
...
assert.match(chigua, /topic-trend-card\.topic-trend-card--featured \{[\s\S]{0,220}height: var\(--chigua-featured-lane-height\)/);
