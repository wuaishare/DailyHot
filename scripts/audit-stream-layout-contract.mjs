...
assert.match(globalStyle, /--ranking-card-featured-thumb-width: 80px;/);
assert.match(globalStyle, /--ranking-card-featured-thumb-height: 64px;/);
assert.match(chigua, /grid-template-columns: var\(--ranking-card-featured-thumb-width\) minmax\(0, 1fr\)/);
...
assert.match(chigua, /object-fit="contain"/);
