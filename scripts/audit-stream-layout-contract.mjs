...
assert.match(chigua, /height: 266px;[\s\S]{0,60}max-height: 266px/);
assert.match(chigua, /is-compact[\s\S]{0,120}height: 252px;[\s\S]{0,60}max-height: 252px/);
...
assert.match(chigua, /:hide-scrollbar="true"/);
