...
assert.match(chigua, /v-if="trendItems.length"[\s\S]{0,120}class="topic-trend-strip"/);
...
assert.match(chigua, /const TREND_SIGNAL_ORDER = \["breakthrough", "rising", "falling", "reentry", "new"\]/);
assert.match(chigua, /takeFirst\(\["breakthrough", "rising"\]\)/);
assert.match(chigua, /takeFirst\(\["falling"\]\)/);
assert.match(chigua, /takeFirst\(\["reentry"\]\)/);
assert.match(chigua, /takeFirst\(\["new"\]\)/);
assert.match(chigua, /return selected\.slice\(0, 4\)/);
