...
assert.match(chigua, /candidate\.score < 64/);
...
assert.match(chigua, /v-if="laneTrendIndicator\(lane, item\) && visibleRankingBadges\(item\)\.length"[\s\S]{0,180}class="event-lane-meta-badges"/);
assert.match(chigua, /v-else-if="visibleRankingBadges\(item\)\.length"[\s\S]{0,180}class="event-lane-title-badges"/);
...
assert.match(chigua, /v-if="eventTrend\(item\) && visibleRankingBadges\(item\)\.length"[\s\S]{0,180}class="event-source-badges"/);
assert.match(chigua, /v-if="eventTrend\(item\)"[\s\S]{0,260}class="trend-pill"/);
assert.match(chigua, /v-else-if="visibleRankingBadges\(item\)\.length"[\s\S]{0,120}:badges="visibleRankingBadges\(item\)"/);
