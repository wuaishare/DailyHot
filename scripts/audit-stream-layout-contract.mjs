...
assert.match(chigua, /featuredLaneOverrides/);
...
assert.match(chigua, /topic-trend-card topic-trend-card--featured/);
assert.match(chigua, /class="topic-trend-strip"/);
assert.match(chigua, /showTrendAsFeaturedLane/);
...
assert.match(chigua, /const direction = rank < baselineRank \? "↑" : rank > baselineRank \? "↓" : "→"/);
assert.match(chigua, /\.radar-trend-item em \{[^}]*font-size: 11px/);
assert.match(chigua, /\.radar-trend-item strong \{[^}]*font-size: 11px/);
assert.match(chigua, /\.radar-trend-item span \{[\s\S]{0,180}font-size: 12px/);
assert.match(chigua, /\.hero-stats > span \{[\s\S]{0,420}font-size: 11px/);
...
assert.match(chigua, /\.topic-trend-card--featured::before/);
assert.match(chigua, /\.topic-trend-card--featured \.topic-trend-title em/);
assert.match(chigua, /\.topic-trend-card--featured \.radar-trend-item \{[\s\S]{0,80}padding: 4px 2px/);
assert.match(chigua, /\.topic-controls-card :deep\(\.compact-filter__label\) \{ font-size: 11px; \}/);
...
assert.match(chigua, /\.topic-trend-title \{[\s\S]{0,100}box-sizing: border-box;[\s\S]{0,120}min-height: 38px/);
...
assert.match(chigua, /FEATURED_LANE_REFRESH_COOLDOWN = 60000/);
assert.match(chigua, /const refreshFeaturedLane = async/);
