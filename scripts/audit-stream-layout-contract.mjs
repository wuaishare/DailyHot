...
assert.match(chigua, /class="topic-featured-lanes"[\s\S]{0,1400}class="topic-section topic-feed-section"/);
...
assert.match(chigua, /height: 224px;[\s\S]{0,60}max-height: 224px/);
