...
assert.match(home, /category-context-nav/);
assert.match(home, /categoryNavigation/);
assert.match(home, /categoryChildren/);
assert.match(home, /parentId/);
assert.match(home, /buildCategoryPath/);
assert.match(home, /category-context-nav__tab/);
...
console.log("[stream-layout-contract] ranking workbench, category hierarchy and continuous-image story cards verified");
