...
assert.match(chigua, /grid-template-columns: minmax\(190px, 272px\) minmax\(0, 720px\) minmax\(190px, 272px\)/);
...
assert.match(chigua, /class="topic-trend-card"/);
assert.match(chigua, /class="topic-trend-list"/);
...
assert.doesNotMatch(chigua, /class="radar-refresh"/);
...
assert.match(chigua, /height: 252px;[\s\S]{0,60}max-height: 252px/);
...
assert.match(chigua, /class="event-lane-hover-cover"/);
assert.match(chigua, /onError: \(\) => markCoverError\(item\.cover\)/);
...
assert.match(chigua, /grid-template-columns: 82px minmax\(0, 1fr\)/);
assert.match(chigua, /font-size: 13px/);
